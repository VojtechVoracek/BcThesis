...
Od verze \ctustyle{}2 beta(f) je možné kromě příkazu "pdfcsplain" použít též
příkaz "luacsplain" (nebo "luatex -fmt pdfcsplain"). V takovém případě se
použije Lua\TeX{} místo pdf\TeX{}u, což má výhodu, že je dokument včetně fontů
zpracován v Unicode.
